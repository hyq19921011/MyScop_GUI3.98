...
extern void SYSCFG_MemoryRemapConfig(uint8_t SYSCFG_MemoryRemap);
extern void SYSCFG_EXTILineConfig(uint8_t EXTI_PortSourceGPIOx, uint8_t EXTI_PinSourcex);
extern void SYSCFG_ETH_MediaInterfaceConfig(uint32_t SYSCFG_ETH_MediaInterface); 
extern void SYSCFG_CompensationCellCmd(FunctionalState NewState); 
